...
<div class="-mt-4 mb-4">
    <template x-for="(field, index) in fields" :key="field.uid">
        <div class="relative flex -mx-2 mt-4 items-end">
            <div
            ...
            <div
                class="mx-2 py-2 w-4/12">
                <label :for="'field_label_'+index">
                    Label
                </label>
                <input
                    type="text"
            ...
            <div
                class="mx-2 py-2 w-5/12">
                <label :for="'field_type_'+index">
                    Type
                </label>
                <select
                    class="form-control"
                    x-model="fields[index].field_type"
